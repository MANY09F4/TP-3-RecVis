...
data_transforms_224_DA = transforms.Compose(
    [
        # Transformations sur PIL.Image
        transforms.Grayscale(num_output_channels=3),         # Convertir en niveaux de gris
        ...
        transforms.RandomPerspective(distortion_scale=0.5, p=0.5),  # Perspective
